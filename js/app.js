...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (isAdmin) {
    ...
    // --- Inject into sidebar (admin pages) ---
    const sidebarNav = document.querySelector('.sidebar-nav .sidebar-section');
    if (isAdminSidebar && sidebarNav) {
      ...
      sidebarNav.appendChild(studentLink);
    }
  }
